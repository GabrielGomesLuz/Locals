...
namespace Locals.Repositories.Models
{
    public class ReservaInteresse
    {
        ...
        [Required(ErrorMessage = "Necessário informar o titular")]
        public string TitularReserva { get; set; }

        [Required(ErrorMessage = "Necessário informar o endereço do titular")]
        [StringLength(60)]
        [Display(Name = "Endereço")]
        public string EndereçoTitular { get; set; }

        [Required(ErrorMessage = "Necessário informar o telefone do titular")]
        [StringLength(11)]
        ...
        [Required(ErrorMessage = "Necessário informar o email do titular")]
